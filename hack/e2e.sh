...
METERING_GENERATE_TEST_NAMESPACES="${METERING_GENERATE_TEST_NAMESPACES:=true}"
...
METERING_OLM_MARKETPLACE_NAMESPACE="${METERING_OLM_MARKETPLACE_NAMESPACE:="openshift-marketplace"}"
METERING_ANSIBLE_OPERATOR_IMAGE_REGISTRY="${METERING_ANSIBLE_OPERATOR_IMAGE_REGISTRY:="registry.svc.ci.openshift.org/ocp/4.8:metering-ansible-operator-registry"}"
...
echo "\$METERING_OLM_MARKETPLACE_NAMESPACE=$METERING_OLM_MARKETPLACE_NAMESPACE"
...
go test \
    ...
    -generate-test-namespaces="${METERING_GENERATE_TEST_NAMESPACES}" \
    ...
    -marketplace-namespace="${METERING_OLM_MARKETPLACE_NAMESPACE}" \
    ${EXTRA_TEST_FLAGS} \
